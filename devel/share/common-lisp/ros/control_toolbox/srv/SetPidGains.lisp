...
(cl:defmethod antiwindup-val ((m <SetPidGains-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_toolbox-srv:antiwindup-val is deprecated.  Use control_toolbox-srv:antiwindup instead.")
  (antiwindup m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SetPidGains-request>)))
  ...
  "4a43159879643e60937bf2893b633607")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SetPidGains-request)))
  "Returns md5sum for a message object of type 'SetPidGains-request"
  "4a43159879643e60937bf2893b633607")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetPidGains-request>)))
  ...
  (cl:format cl:nil "float64 p~%float64 i~%float64 d~%float64 i_clamp~%bool antiwindup~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetPidGains-request)))
  "Returns full string definition for message of type 'SetPidGains-request"
  (cl:format cl:nil "float64 p~%float64 i~%float64 d~%float64 i_clamp~%bool antiwindup~%~%~%"))
